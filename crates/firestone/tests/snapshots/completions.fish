...
complete -c firestone -n "__fish_firestone_using_subcommand help; and not __fish_seen_subcommand_from run create start stop restart resize rm ls show edit shell ssh-config console logs catalog images doctor completions version serve ui help" -f -a "run" -d 'Create or reuse a machine, start it, and open an SSH shell'
complete -c firestone -n "__fish_firestone_using_subcommand help; and not __fish_seen_subcommand_from run create start stop restart resize rm ls show edit shell ssh-config console logs catalog images doctor completions version serve ui help" -f -a "create" -d 'Create a machine definition without booting it'
complete -c firestone -n "__fish_firestone_using_subcommand help; and not __fish_seen_subcommand_from run create start stop restart resize rm ls show edit shell ssh-config console logs catalog images doctor completions version serve ui help" -f -a "start" -d 'Start a machine and wait for SSH readiness'
complete -c firestone -n "__fish_firestone_using_subcommand help; and not __fish_seen_subcommand_from run create start stop restart resize rm ls show edit shell ssh-config console logs catalog images doctor completions version serve ui help" -f -a "stop" -d 'Stop a machine'
complete -c firestone -n "__fish_firestone_using_subcommand help; and not __fish_seen_subcommand_from run create start stop restart resize rm ls show edit shell ssh-config console logs catalog images doctor completions version serve ui help" -f -a "restart" -d 'Stop and start a machine'
complete -c firestone -n "__fish_firestone_using_subcommand help; and not __fish_seen_subcommand_from run create start stop restart resize rm ls show edit shell ssh-config console logs catalog images doctor completions version serve ui help" -f -a "resize" -d 'Change a machine\'s CPU count or memory'
complete -c firestone -n "__fish_firestone_using_subcommand help; and not __fish_seen_subcommand_from run create start stop restart resize rm ls show edit shell ssh-config console logs catalog images doctor completions version serve ui help" -f -a "rm" -d 'Stop and remove one or more machines'
complete -c firestone -n "__fish_firestone_using_subcommand help; and not __fish_seen_subcommand_from run create start stop restart resize rm ls show edit shell ssh-config console logs catalog images doctor completions version serve ui help" -f -a "ls" -d 'List machines'
complete -c firestone -n "__fish_firestone_using_subcommand help; and not __fish_seen_subcommand_from run create start stop restart resize rm ls show edit shell ssh-config console logs catalog images doctor completions version serve ui help" -f -a "show" -d 'Show a machine\'s specification and runtime state'
complete -c firestone -n "__fish_firestone_using_subcommand help; and not __fish_seen_subcommand_from run create start stop restart resize rm ls show edit shell ssh-config console logs catalog images doctor completions version serve ui help" -f -a "edit" -d 'Edit and validate a machine\'s firestone.toml'
complete -c firestone -n "__fish_firestone_using_subcommand help; and not __fish_seen_subcommand_from run create start stop restart resize rm ls show edit shell ssh-config console logs catalog images doctor completions version serve ui help" -f -a "shell" -d 'Open SSH over the machine\'s private vsock transport'
complete -c firestone -n "__fish_firestone_using_subcommand help; and not __fish_seen_subcommand_from run create start stop restart resize rm ls show edit shell ssh-config console logs catalog images doctor completions version serve ui help" -f -a "ssh-config" -d 'Print an OpenSSH Host block for the machine'
complete -c firestone -n "__fish_firestone_using_subcommand help; and not __fish_seen_subcommand_from run create start stop restart resize rm ls show edit shell ssh-config console logs catalog images doctor completions version serve ui help" -f -a "console" -d 'Attach to the machine\'s hvc0 console'
complete -c firestone -n "__fish_firestone_using_subcommand help; and not __fish_seen_subcommand_from run create start stop restart resize rm ls show edit shell ssh-config console logs catalog images doctor completions version serve ui help" -f -a "logs" -d 'Print a bounded machine log'
complete -c firestone -n "__fish_firestone_using_subcommand help; and not __fish_seen_subcommand_from run create start stop restart resize rm ls show edit shell ssh-config console logs catalog images doctor completions version serve ui help" -f -a "catalog" -d 'Print the merged built-in and user image catalog'
complete -c firestone -n "__fish_firestone_using_subcommand help; and not __fish_seen_subcommand_from run create start stop restart resize rm ls show edit shell ssh-config console logs catalog images doctor completions version serve ui help" -f -a "images" -d 'Manage the owned image store'
complete -c firestone -n "__fish_firestone_using_subcommand help; and not __fish_seen_subcommand_from run create start stop restart resize rm ls show edit shell ssh-config console logs catalog images doctor completions version serve ui help" -f -a "doctor" -d 'Check host requirements and optional safe repairs'
complete -c firestone -n "__fish_firestone_using_subcommand help; and not __fish_seen_subcommand_from run create start stop restart resize rm ls show edit shell ssh-config console logs catalog images doctor completions version serve ui help" -f -a "completions" -d 'Generate a shell completion script on stdout'
complete -c firestone -n "__fish_firestone_using_subcommand help; and not __fish_seen_subcommand_from run create start stop restart resize rm ls show edit shell ssh-config console logs catalog images doctor completions version serve ui help" -f -a "version" -d 'Print Firestone, pinned dependency, and resolved path versions'
complete -c firestone -n "__fish_firestone_using_subcommand help; and not __fish_seen_subcommand_from run create start stop restart resize rm ls show edit shell ssh-config console logs catalog images doctor completions version serve ui help" -f -a "serve" -d 'Run the stateless REST API over a private Unix socket or loopback port'
complete -c firestone -n "__fish_firestone_using_subcommand help; and not __fish_seen_subcommand_from run create start stop restart resize rm ls show edit shell ssh-config console logs catalog images doctor completions version serve ui help" -f -a "ui" -d 'Open the Firestone web interface on a loopback port'
complete -c firestone -n "__fish_firestone_using_subcommand help; and not __fish_seen_subcommand_from run create start stop restart resize rm ls show edit shell ssh-config console logs catalog images doctor completions version serve ui help" -f -a "help" -d 'Print this message or the help of the given subcommand(s)'
