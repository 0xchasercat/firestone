...
| M4-01 | Axum REST router, routes, streaming, and error mapping | `agent/m4-api` | [#26](https://github.com/0xchasercat/firestone/pull/26) | review | M3-04 | Every SPEC route projects shared actions/results, NDJSON framing and limits are exact, and handler tests pass with a mocked Dispatcher |
