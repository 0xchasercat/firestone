...
# Cloud Hypervisor's own kernel release supplies the direct-boot kernel used by
# OCI machines. Its builtin configuration is recorded in SPEC.md section 10.5.
readonly CH_KERNEL_VERSION="ch-release-v6.16.9-20260508"
readonly CH_KERNEL_RELEASE_URL="https://github.com/cloud-hypervisor/linux/releases/tag/ch-release-v6.16.9-20260508"
readonly CH_KERNEL_X86_64_URL="https://github.com/cloud-hypervisor/linux/releases/download/ch-release-v6.16.9-20260508/bzImage-x86_64"
readonly CH_KERNEL_AARCH64_URL="https://github.com/cloud-hypervisor/linux/releases/download/ch-release-v6.16.9-20260508/Image-arm64"
...
readonly HELPERS_RELEASE_TAG="helpers-v0.2.0-firestone.1"
...
readonly HELPERS_SOURCE_URL="$HELPERS_ASSET_BASE/firestone-static-helpers-v0.2.0-corresponding-source.tar"
readonly HELPERS_BUILD_INFO_URL="$HELPERS_ASSET_BASE/firestone-static-helpers-v0.2.0-build-info.txt"
readonly MKFS_EXT4_VERSION="1.47.3"
readonly MKFS_EXT4_X86_64_URL="$HELPERS_ASSET_BASE/mkfs.ext4-1.47.3-x86_64-unknown-linux-musl"
readonly E2FSPROGS_SOURCE_URL="https://cdn.kernel.org/pub/linux/kernel/people/tytso/e2fsprogs/v1.47.3/e2fsprogs-1.47.3.tar.xz"
readonly LIBARCHIVE_VERSION="3.8.3"
readonly LIBARCHIVE_SOURCE_URL="https://distfiles.alpinelinux.org/distfiles/v3.22/libarchive-3.8.3.tar.xz"

# Firestone's own guest PID 1 (SPEC section 10.5) is published under its own
# release tag, the way virtiofsd is, so pinning the payload never waits for a
# Firestone version release that would in turn embed this payload.
readonly FIRESTONE_INIT_VERSION="v0.1.0"
readonly FIRESTONE_INIT_RELEASE_TAG="firestone-init-v0.1.0-firestone.1"
readonly FIRESTONE_INIT_RELEASE_URL="https://github.com/0xchasercat/firestone/releases/tag/$FIRESTONE_INIT_RELEASE_TAG"
readonly FIRESTONE_INIT_X86_64_URL="https://github.com/0xchasercat/firestone/releases/download/$FIRESTONE_INIT_RELEASE_TAG/firestone-init-$FIRESTONE_INIT_VERSION-x86_64-unknown-linux-musl"
...
verify_manifest_metadata() {
    ...
    require_manifest_value dependency.cloud-hypervisor-kernel version "$CH_KERNEL_VERSION"
    require_manifest_value dependency.cloud-hypervisor-kernel release_url "$CH_KERNEL_RELEASE_URL"
    require_manifest_value dependency.cloud-hypervisor-kernel availability binary
    ...
    require_manifest_value dependency.mkfs-ext4 version "$MKFS_EXT4_VERSION"
    require_manifest_value dependency.mkfs-ext4 release_url "$HELPERS_RELEASE_URL"
    require_manifest_value dependency.mkfs-ext4 availability binary
    require_manifest_value dependency.mkfs-ext4.x86_64 url "$MKFS_EXT4_X86_64_URL"
    require_manifest_value dependency.firestone-init version "$FIRESTONE_INIT_VERSION"
    require_manifest_value dependency.firestone-init release_url "$FIRESTONE_INIT_RELEASE_URL"
    require_manifest_value dependency.firestone-init availability binary
    require_manifest_value dependency.firestone-init.x86_64 url "$FIRESTONE_INIT_X86_64_URL"
    require_manifest_value helper.e2fsprogs version "$MKFS_EXT4_VERSION"
    require_manifest_value helper.e2fsprogs architecture x86_64
    require_manifest_value helper.e2fsprogs.source url "$E2FSPROGS_SOURCE_URL"
    require_manifest_value helper.libarchive version "$LIBARCHIVE_VERSION"
    require_manifest_value helper.libarchive architecture x86_64
    require_manifest_value helper.libarchive.source url "$LIBARCHIVE_SOURCE_URL"
    ...
    require_manifest_sha dependency.cloud-hypervisor-kernel.x86_64
    require_manifest_sha dependency.cloud-hypervisor-kernel.aarch64
    ...
    require_manifest_sha dependency.mkfs-ext4.x86_64
    require_manifest_sha dependency.firestone-init.x86_64
    require_manifest_sha helper.e2fsprogs.source
    require_manifest_sha helper.libarchive.source
}
...
verify_arch() {
    ...
    case "$selected_arch" in
        x86_64)
            ...
            verify_artifact dependency.cloud-hypervisor-kernel.x86_64 cloud-hypervisor-kernel-x86_64 "$CH_KERNEL_X86_64_URL"
            ...
            verify_artifact dependency.mkfs-ext4.x86_64 mkfs-ext4-x86_64 "$MKFS_EXT4_X86_64_URL"
            verify_artifact dependency.firestone-init.x86_64 firestone-init-x86_64 "$FIRESTONE_INIT_X86_64_URL"
            ;;
        aarch64)
            ...
            verify_artifact dependency.cloud-hypervisor-kernel.aarch64 cloud-hypervisor-kernel-aarch64 "$CH_KERNEL_AARCH64_URL"
...
write_manifest() {
    ...
    shift 8
    local ch_kernel_x86_sha=$1
    local ch_kernel_arm_sha=$2
    local mkfs_ext4_x86_sha=$3
    local e2fsprogs_source_sha=$4
    local libarchive_source_sha=$5
    local firestone_init_x86_sha=$6
...
# Direct-boot kernel for OCI machines; the firmware payload path is untouched.
[dependency.cloud-hypervisor-kernel]
version = "$CH_KERNEL_VERSION"
release_url = "$CH_KERNEL_RELEASE_URL"
availability = "binary"

[dependency.cloud-hypervisor-kernel.x86_64]
asset = "bzImage-x86_64"
install_name = "bzImage-$CH_KERNEL_VERSION"
url = "$CH_KERNEL_X86_64_URL"
sha256 = "$ch_kernel_x86_sha"

[dependency.cloud-hypervisor-kernel.aarch64]
asset = "Image-arm64"
install_name = "Image-$CH_KERNEL_VERSION"
url = "$CH_KERNEL_AARCH64_URL"
sha256 = "$ch_kernel_arm_sha"
...
[dependency.mkfs-ext4]
version = "$MKFS_EXT4_VERSION"
release_url = "$HELPERS_RELEASE_URL"
availability = "binary"
architectures = ["x86_64"]
license = "GPL-2.0-only AND BSD-2-Clause"

[dependency.mkfs-ext4.x86_64]
asset = "mkfs.ext4-1.47.3-x86_64-unknown-linux-musl"
install_name = "mkfs.ext4-1.47.3"
url = "$MKFS_EXT4_X86_64_URL"
sha256 = "$mkfs_ext4_x86_sha"

# Firestone's own guest PID 1, published under its own release tag and embedded
# in the x86_64 standalone release; a source build downloads it on first OCI use.
[dependency.firestone-init]
version = "$FIRESTONE_INIT_VERSION"
...
install_name = "firestone-init-$FIRESTONE_INIT_VERSION"
url = "$FIRESTONE_INIT_X86_64_URL"
sha256 = "$firestone_init_x86_sha"

[helper.release]
tag = "$HELPERS_RELEASE_TAG"

[helper.release.corresponding-source]
asset = "firestone-static-helpers-v0.2.0-corresponding-source.tar"
url = "$HELPERS_SOURCE_URL"
sha256 = "$helpers_source_sha"

[helper.release.build-info]
asset = "firestone-static-helpers-v0.2.0-build-info.txt"
...
[helper.e2fsprogs.source]
asset = "e2fsprogs-$MKFS_EXT4_VERSION.tar.xz"
url = "$E2FSPROGS_SOURCE_URL"
sha256 = "$e2fsprogs_source_sha"
...
[helper.libarchive.source]
asset = "libarchive-$LIBARCHIVE_VERSION.tar.xz"
url = "$LIBARCHIVE_SOURCE_URL"
sha256 = "$libarchive_source_sha"
EOF
}
...
verify_manifest_shape() {
    ...
    write_manifest \
        ...
        "$(manifest_value dependency.cloud-hypervisor-kernel.x86_64 sha256)" \
        "$(manifest_value dependency.cloud-hypervisor-kernel.aarch64 sha256)" \
        "$(manifest_value dependency.mkfs-ext4.x86_64 sha256)" \
        "$(manifest_value helper.e2fsprogs.source sha256)" \
        "$(manifest_value helper.libarchive.source sha256)" \
        "$(manifest_value dependency.firestone-init.x86_64 sha256)"
...
if [[ "$command_name" == refresh ]]; then
    ...
    ch_kernel_x86_sha=$(download_hash cloud-hypervisor-kernel-x86_64 "$CH_KERNEL_X86_64_URL")
    ch_kernel_arm_sha=$(download_hash cloud-hypervisor-kernel-aarch64 "$CH_KERNEL_AARCH64_URL")
    ...
    mkfs_ext4_x86_sha=$(download_hash mkfs-ext4-x86_64 "$MKFS_EXT4_X86_64_URL")
    e2fsprogs_source_sha=$(download_hash e2fsprogs-source "$E2FSPROGS_SOURCE_URL")
    libarchive_source_sha=$(download_hash libarchive-source "$LIBARCHIVE_SOURCE_URL")
    firestone_init_x86_sha=$(download_hash firestone-init-x86_64 "$FIRESTONE_INIT_X86_64_URL")
    ...
    write_manifest \
        ...
        "$ch_kernel_arm_sha" \
        "$mkfs_ext4_x86_sha" \
        "$e2fsprogs_source_sha" \
        "$libarchive_source_sha" \
        "$firestone_init_x86_sha"
...
verify_artifact helper.e2fsprogs.source e2fsprogs-source "$E2FSPROGS_SOURCE_URL"
verify_artifact helper.libarchive.source libarchive-source "$LIBARCHIVE_SOURCE_URL"
