...
| M1-01 | Image store, pull/verify, raw conversion, overlay, remove, prune | `agent/m1-images` | [#13](https://github.com/0xchasercat/firestone/pull/13) | in review | M0 | Immutable source identity, owned qcow2 storage, overlay and image lifecycle tests pass |
