...
| M2-01 | SSH identity, host-key trust, and vsock proxy transport | `agent/m2-transport` | [#17](https://github.com/0xchasercat/firestone/pull/17) | in review | M1 | Exact SSH/vsock transport contracts, key permissions, trust rotation, cancellation, and verify 13 and 17 pass without KVM |
| M2-02 | Guest SSH units and cloud-init integration | `agent/m2-guest` | [#18](https://github.com/0xchasercat/firestone/pull/18) | in review | M1 | Typed deterministic guest units activate key-only root/default-user SSH, coexist with native systemd vsock, preserve first-boot hvc0 rescue, and KVM verify 11 and 17 pass |
