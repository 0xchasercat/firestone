...
use firestone_core::{
    ...
    ReadinessOptions, RealValidationHost, RemoveResult, ResizeResult, ShimClient, ShimTimeouts,
    SpecResult, SpecWarningPayload, StartResult, StateImage, StateStore, StateVersion, StopResult,
    Supervision, ValidationContext, VersionDependency, VersionIdentity, VersionPaths,
    VersionResult, VmmApi, atomic, cancel_prepared, disk_shrink_error, launch_prepared_cancellable,
    overlay_virtual_size, prepare_start, read_reconciled_machine_state_live,
...
mod tests {
    ...
    use super::{
        ...
        format_uptime_seconds, parse_editor_command, published_vmconfig_capacity,
    };
