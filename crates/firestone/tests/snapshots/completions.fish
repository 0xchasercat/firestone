...
complete -c firestone -n "__fish_firestone_needs_command" -f -a "uninstall" -d 'Remove the firestone executable, and with --purge its data'
...
complete -c firestone -n "__fish_firestone_using_subcommand serve" -l host -d 'Loopback address to bind with --port. Defaults to 127.0.0.1' -r
complete -c firestone -n "__fish_firestone_using_subcommand serve" -l port -d 'Loopback TCP port to bind. Same listener as --listen tcp:127.0.0.1:PORT' -r
...
complete -c firestone -n "__fish_firestone_using_subcommand system; and not __fish_seen_subcommand_from prune metrics help" -l home -d 'Override the Firestone home root (config, data, and runtime)' -r -F
complete -c firestone -n "__fish_firestone_using_subcommand system; and not __fish_seen_subcommand_from prune metrics help" -l json -d 'Print events as newline-delimited JSON and disable human output'
complete -c firestone -n "__fish_firestone_using_subcommand system; and not __fish_seen_subcommand_from prune metrics help" -s q -l quiet -d 'Print only errors and command results'
complete -c firestone -n "__fish_firestone_using_subcommand system; and not __fish_seen_subcommand_from prune metrics help" -s v -l verbose -d 'Increase log detail. Pass twice for debug output'
complete -c firestone -n "__fish_firestone_using_subcommand system; and not __fish_seen_subcommand_from prune metrics help" -l no-color -d 'Disable colored output'
complete -c firestone -n "__fish_firestone_using_subcommand system; and not __fish_seen_subcommand_from prune metrics help" -s y -l yes -d 'Assume yes when a command may prompt'
complete -c firestone -n "__fish_firestone_using_subcommand system; and not __fish_seen_subcommand_from prune metrics help" -s h -l help -d 'Print help'
complete -c firestone -n "__fish_firestone_using_subcommand system; and not __fish_seen_subcommand_from prune metrics help" -f -a "prune" -d 'Reclaim disk space held by Firestone\'s own artifacts'
complete -c firestone -n "__fish_firestone_using_subcommand system; and not __fish_seen_subcommand_from prune metrics help" -f -a "metrics" -d 'Print one sample of host CPU, memory, and data-directory space'
complete -c firestone -n "__fish_firestone_using_subcommand system; and not __fish_seen_subcommand_from prune metrics help" -f -a "help" -d 'Print this message or the help of the given subcommand(s)'
...
complete -c firestone -n "__fish_firestone_using_subcommand system; and __fish_seen_subcommand_from metrics" -l home -d 'Override the Firestone home root (config, data, and runtime)' -r -F
complete -c firestone -n "__fish_firestone_using_subcommand system; and __fish_seen_subcommand_from metrics" -l json -d 'Print events as newline-delimited JSON and disable human output'
complete -c firestone -n "__fish_firestone_using_subcommand system; and __fish_seen_subcommand_from metrics" -s q -l quiet -d 'Print only errors and command results'
complete -c firestone -n "__fish_firestone_using_subcommand system; and __fish_seen_subcommand_from metrics" -s v -l verbose -d 'Increase log detail. Pass twice for debug output'
complete -c firestone -n "__fish_firestone_using_subcommand system; and __fish_seen_subcommand_from metrics" -l no-color -d 'Disable colored output'
complete -c firestone -n "__fish_firestone_using_subcommand system; and __fish_seen_subcommand_from metrics" -s y -l yes -d 'Assume yes when a command may prompt'
complete -c firestone -n "__fish_firestone_using_subcommand system; and __fish_seen_subcommand_from metrics" -s h -l help -d 'Print help'
...
complete -c firestone -n "__fish_firestone_using_subcommand system; and __fish_seen_subcommand_from help" -f -a "metrics" -d 'Print one sample of host CPU, memory, and data-directory space'
...
complete -c firestone -n "__fish_firestone_using_subcommand uninstall" -l home -d 'Override the Firestone home root (config, data, and runtime)' -r -F
complete -c firestone -n "__fish_firestone_using_subcommand uninstall" -l purge -d 'Also delete the config, data, and runtime directories'
complete -c firestone -n "__fish_firestone_using_subcommand uninstall" -l json -d 'Print events as newline-delimited JSON and disable human output'
complete -c firestone -n "__fish_firestone_using_subcommand uninstall" -s q -l quiet -d 'Print only errors and command results'
complete -c firestone -n "__fish_firestone_using_subcommand uninstall" -s v -l verbose -d 'Increase log detail. Pass twice for debug output'
complete -c firestone -n "__fish_firestone_using_subcommand uninstall" -l no-color -d 'Disable colored output'
complete -c firestone -n "__fish_firestone_using_subcommand uninstall" -s y -l yes -d 'Assume yes when a command may prompt'
complete -c firestone -n "__fish_firestone_using_subcommand uninstall" -s h -l help -d 'Print help'
complete -c firestone -n "__fish_firestone_using_subcommand help; and not __fish_seen_subcommand_from run create start stop restart resize rm ls show edit shell cp ssh-config console logs metrics catalog images doctor completions version serve ui clone snapshot system uninstall help" -f -a "run" -d 'Create or reuse a machine, start it, and open an SSH shell'
complete -c firestone -n "__fish_firestone_using_subcommand help; and not __fish_seen_subcommand_from run create start stop restart resize rm ls show edit shell cp ssh-config console logs metrics catalog images doctor completions version serve ui clone snapshot system uninstall help" -f -a "create" -d 'Create a machine definition without booting it'
complete -c firestone -n "__fish_firestone_using_subcommand help; and not __fish_seen_subcommand_from run create start stop restart resize rm ls show edit shell cp ssh-config console logs metrics catalog images doctor completions version serve ui clone snapshot system uninstall help" -f -a "start" -d 'Start a machine and wait for SSH readiness'
complete -c firestone -n "__fish_firestone_using_subcommand help; and not __fish_seen_subcommand_from run create start stop restart resize rm ls show edit shell cp ssh-config console logs metrics catalog images doctor completions version serve ui clone snapshot system uninstall help" -f -a "stop" -d 'Stop a machine'
complete -c firestone -n "__fish_firestone_using_subcommand help; and not __fish_seen_subcommand_from run create start stop restart resize rm ls show edit shell cp ssh-config console logs metrics catalog images doctor completions version serve ui clone snapshot system uninstall help" -f -a "restart" -d 'Stop and start a machine'
complete -c firestone -n "__fish_firestone_using_subcommand help; and not __fish_seen_subcommand_from run create start stop restart resize rm ls show edit shell cp ssh-config console logs metrics catalog images doctor completions version serve ui clone snapshot system uninstall help" -f -a "resize" -d 'Change a machine\'s CPU count or memory'
complete -c firestone -n "__fish_firestone_using_subcommand help; and not __fish_seen_subcommand_from run create start stop restart resize rm ls show edit shell cp ssh-config console logs metrics catalog images doctor completions version serve ui clone snapshot system uninstall help" -f -a "rm" -d 'Stop and remove one or more machines'
complete -c firestone -n "__fish_firestone_using_subcommand help; and not __fish_seen_subcommand_from run create start stop restart resize rm ls show edit shell cp ssh-config console logs metrics catalog images doctor completions version serve ui clone snapshot system uninstall help" -f -a "ls" -d 'List machines'
complete -c firestone -n "__fish_firestone_using_subcommand help; and not __fish_seen_subcommand_from run create start stop restart resize rm ls show edit shell cp ssh-config console logs metrics catalog images doctor completions version serve ui clone snapshot system uninstall help" -f -a "show" -d 'Show a machine\'s specification and runtime state'
complete -c firestone -n "__fish_firestone_using_subcommand help; and not __fish_seen_subcommand_from run create start stop restart resize rm ls show edit shell cp ssh-config console logs metrics catalog images doctor completions version serve ui clone snapshot system uninstall help" -f -a "edit" -d 'Edit and validate a machine\'s firestone.toml'
complete -c firestone -n "__fish_firestone_using_subcommand help; and not __fish_seen_subcommand_from run create start stop restart resize rm ls show edit shell cp ssh-config console logs metrics catalog images doctor completions version serve ui clone snapshot system uninstall help" -f -a "shell" -d 'Open SSH over the machine\'s private vsock transport'
complete -c firestone -n "__fish_firestone_using_subcommand help; and not __fish_seen_subcommand_from run create start stop restart resize rm ls show edit shell cp ssh-config console logs metrics catalog images doctor completions version serve ui clone snapshot system uninstall help" -f -a "cp" -d 'Copy files between the host and a machine over the vsock transport'
complete -c firestone -n "__fish_firestone_using_subcommand help; and not __fish_seen_subcommand_from run create start stop restart resize rm ls show edit shell cp ssh-config console logs metrics catalog images doctor completions version serve ui clone snapshot system uninstall help" -f -a "ssh-config" -d 'Print an OpenSSH Host block for the machine'
complete -c firestone -n "__fish_firestone_using_subcommand help; and not __fish_seen_subcommand_from run create start stop restart resize rm ls show edit shell cp ssh-config console logs metrics catalog images doctor completions version serve ui clone snapshot system uninstall help" -f -a "console" -d 'Attach to the machine\'s hvc0 console'
complete -c firestone -n "__fish_firestone_using_subcommand help; and not __fish_seen_subcommand_from run create start stop restart resize rm ls show edit shell cp ssh-config console logs metrics catalog images doctor completions version serve ui clone snapshot system uninstall help" -f -a "logs" -d 'Print a bounded machine log'
complete -c firestone -n "__fish_firestone_using_subcommand help; and not __fish_seen_subcommand_from run create start stop restart resize rm ls show edit shell cp ssh-config console logs metrics catalog images doctor completions version serve ui clone snapshot system uninstall help" -f -a "metrics" -d 'Print one cumulative resource sample for a running machine'
complete -c firestone -n "__fish_firestone_using_subcommand help; and not __fish_seen_subcommand_from run create start stop restart resize rm ls show edit shell cp ssh-config console logs metrics catalog images doctor completions version serve ui clone snapshot system uninstall help" -f -a "catalog" -d 'Print the merged built-in and user image catalog'
complete -c firestone -n "__fish_firestone_using_subcommand help; and not __fish_seen_subcommand_from run create start stop restart resize rm ls show edit shell cp ssh-config console logs metrics catalog images doctor completions version serve ui clone snapshot system uninstall help" -f -a "images" -d 'Manage the owned image store'
complete -c firestone -n "__fish_firestone_using_subcommand help; and not __fish_seen_subcommand_from run create start stop restart resize rm ls show edit shell cp ssh-config console logs metrics catalog images doctor completions version serve ui clone snapshot system uninstall help" -f -a "doctor" -d 'Check host requirements and optional safe repairs'
complete -c firestone -n "__fish_firestone_using_subcommand help; and not __fish_seen_subcommand_from run create start stop restart resize rm ls show edit shell cp ssh-config console logs metrics catalog images doctor completions version serve ui clone snapshot system uninstall help" -f -a "completions" -d 'Generate a shell completion script on stdout'
complete -c firestone -n "__fish_firestone_using_subcommand help; and not __fish_seen_subcommand_from run create start stop restart resize rm ls show edit shell cp ssh-config console logs metrics catalog images doctor completions version serve ui clone snapshot system uninstall help" -f -a "version" -d 'Print Firestone, pinned dependency, and resolved path versions'
complete -c firestone -n "__fish_firestone_using_subcommand help; and not __fish_seen_subcommand_from run create start stop restart resize rm ls show edit shell cp ssh-config console logs metrics catalog images doctor completions version serve ui clone snapshot system uninstall help" -f -a "serve" -d 'Run the stateless REST API over a private Unix socket or loopback port'
complete -c firestone -n "__fish_firestone_using_subcommand help; and not __fish_seen_subcommand_from run create start stop restart resize rm ls show edit shell cp ssh-config console logs metrics catalog images doctor completions version serve ui clone snapshot system uninstall help" -f -a "ui" -d 'Open the Firestone web interface on a loopback port'
complete -c firestone -n "__fish_firestone_using_subcommand help; and not __fish_seen_subcommand_from run create start stop restart resize rm ls show edit shell cp ssh-config console logs metrics catalog images doctor completions version serve ui clone snapshot system uninstall help" -f -a "clone" -d 'Copy a stopped machine\'s spec and disk to a new machine'
complete -c firestone -n "__fish_firestone_using_subcommand help; and not __fish_seen_subcommand_from run create start stop restart resize rm ls show edit shell cp ssh-config console logs metrics catalog images doctor completions version serve ui clone snapshot system uninstall help" -f -a "snapshot" -d 'Capture, list, restore, and remove machine snapshots'
complete -c firestone -n "__fish_firestone_using_subcommand help; and not __fish_seen_subcommand_from run create start stop restart resize rm ls show edit shell cp ssh-config console logs metrics catalog images doctor completions version serve ui clone snapshot system uninstall help" -f -a "system" -d 'Inspect and reclaim host-wide Firestone storage'
complete -c firestone -n "__fish_firestone_using_subcommand help; and not __fish_seen_subcommand_from run create start stop restart resize rm ls show edit shell cp ssh-config console logs metrics catalog images doctor completions version serve ui clone snapshot system uninstall help" -f -a "uninstall" -d 'Remove the firestone executable, and with --purge its data'
complete -c firestone -n "__fish_firestone_using_subcommand help; and not __fish_seen_subcommand_from run create start stop restart resize rm ls show edit shell cp ssh-config console logs metrics catalog images doctor completions version serve ui clone snapshot system uninstall help" -f -a "help" -d 'Print this message or the help of the given subcommand(s)'
...
complete -c firestone -n "__fish_firestone_using_subcommand help; and __fish_seen_subcommand_from system" -f -a "metrics" -d 'Print one sample of host CPU, memory, and data-directory space'
