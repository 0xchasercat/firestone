...
# The standalone helper build publishes no binary pin yet. These are the exact
# signed/tagged upstream sources consumed by build/helpers.
...
# Source pins for the unpublished x86_64 static helper build.
[helper.passt]
