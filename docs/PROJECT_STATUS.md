...
| M3-01 | Passt, forward grammar, and tap network plans | `agent/m3-network` | pending | review | M2 | Exact pinned passt/tap commands, socket/config plans, forward validation, and bounded errors pass without KVM |
