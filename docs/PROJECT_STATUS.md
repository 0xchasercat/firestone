...
| M5-07 | Embed pinned Cloud Hypervisor in x86_64 standalone release | `agent/embed-cloud-hypervisor` | pending | in progress | M5-05 | Strict release embedding, secure lazy default-VMM materialization, custom override precedence, doctor repair without VMM download, exact hash/version release smoke, required gates, and final CI pass |
