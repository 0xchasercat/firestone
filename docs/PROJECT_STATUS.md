...
| M4-02 | Serve CLI and HTTP runtime integration | `agent/m4-serve` | [#27](https://github.com/0xchasercat/firestone/pull/27) | review | M4-01 | Unix-only mode-0600 listener, secure conflict/stale takeover, identity cleanup, concurrent LocalDispatcher requests, bounded signal drain, follow cancellation, and real CLI lifecycle smoke pass; local stable and Rust 1.85 full gates plus final-head Ubuntu x86_64 CI runs [33270866362](https://github.com/0xchasercat/firestone/actions/runs/33270866362) and [33270864595](https://github.com/0xchasercat/firestone/actions/runs/33270864595) are green; no KVM claim |
