...
| M1-04 | Shim process supervision, launch, status, stop, and cleanup | `agent/m1-shim` | [#14](https://github.com/0xchasercat/firestone/pull/14) | in review | M1-01, M1-02, M1-03 | Linux x86_64 acceptance uses pinned Cloud Hypervisor v53 + edk2; ordered launch/stop, ownership cleanup, deadlines, lock lifetime, client detachment, child reaping, and verified crash recovery pass. aarch64 runtime, non-Linux authority, and hostile wrapper containment are deferred |
