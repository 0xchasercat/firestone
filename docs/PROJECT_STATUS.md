...
| M1-04 | Shim process supervision, launch, status, stop, and cleanup | `agent/m1-shim` | [#14](https://github.com/0xchasercat/firestone/pull/14) | in review | M1-01, M1-02, M1-03 | Ordered launch/stop, state writes, process identity, logs, and crash paths pass on Linux |
