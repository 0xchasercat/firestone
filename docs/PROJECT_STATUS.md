...
| M1-02 | Deterministic cloud-init seed and canonical typed VmConfig | `agent/m1-seed-vmconfig` | [#12](https://github.com/0xchasercat/firestone/pull/12) | in review | M0 | CIDATA golden and every VmConfig mapping/overlay contract pass without KVM |
