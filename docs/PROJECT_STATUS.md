...
| M2-04 | M2 Linux KVM integration | `agent/m2-integration` | pending | ready | M2-01 through M2-03 | E2E 2 and 10 pass; empty-home run reaches a root prompt; verify 11, 13, and 17 close |
