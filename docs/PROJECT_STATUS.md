...
| M3-04 | Network/filesystem sidecars and CLI lifecycle integration | `agent/m3-sidecars` | [#24](https://github.com/0xchasercat/firestone/pull/24) | review | M3-01 through M3-03 | Exact prepared plans drive VmConfig/results; shim launch, rollback, degradation, stop, reaping, and Linux recovery cover passt plus ordered virtiofsd sidecars; local stable/1.85 gates pass and final-head Linux CI is required |
