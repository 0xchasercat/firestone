...
| M3-04 | Network/filesystem sidecars and CLI lifecycle integration | `agent/m3-sidecars` | pending | ready | M3-01 through M3-03 | Shim launch/stop/recovery integrates passt, tap, virtiofsd, forwards, mounts, and shared CLI contracts |
