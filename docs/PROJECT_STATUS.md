...
| M0-04 | CLI parser, renderers, create/list/show/edit/doctor, dispatcher adapters | `agent/m0-cli` | pending | ready | M0-01, M0-02, M0-03b, M0-05a, M0-05b | M0 no-KVM command acceptance and renderer snapshots pass |
