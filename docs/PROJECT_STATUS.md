...
| M0-03a | Built-in catalog data and authoritative source validation | `agent/m0-catalog-data` | [#2](https://github.com/0xchasercat/firestone/pull/2) | ready for review | baseline | Initial entries have current per-architecture URLs and checksum sources; unbooted entries are marked as release gates |
