...
| M4-02 | Serve CLI and HTTP runtime integration | `agent/m4-serve` | pending | ready | M4-01 | Bind policy, graceful shutdown, cancellation, concurrency, deterministic errors, and CLI lifecycle smoke pass |
