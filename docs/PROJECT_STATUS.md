...
| M1-05 | Lifecycle and image CLI integration | `agent/m1-lifecycle` | pending | ready | M1-01 through M1-04 | start/stop/restart/rm/images/logs/show-vmconfig project shared actions and preserve renderer contracts |
