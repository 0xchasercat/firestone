...
| M3-01 | Passt, forward grammar, and tap network plans | `agent/m3-network` | [#23](https://github.com/0xchasercat/firestone/pull/23) | review | M2 | Exact pinned passt/tap commands, socket/config plans, forward validation, and bounded errors pass without KVM |
| M3-02 | Virtiofsd mount plans and VmConfig mapping | `agent/m3-virtiofs` | [#22](https://github.com/0xchasercat/firestone/pull/22) | review | M2 | Exact pinned virtiofsd commands, tags, read-only mapping, ownership, and bounded errors pass without KVM |
